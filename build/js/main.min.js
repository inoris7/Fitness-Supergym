...
/* harmony import */ var _modules_play_button__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/play-button */ "./js/modules/play-button.js");
/* harmony import */ var _modules_play_button__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_play_button__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _modules_coaches_slider__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_coaches_slider__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _modules_feedback_carousel__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/feedback-carousel */ "./js/modules/feedback-carousel.js");
/* harmony import */ var _modules_feedback_carousel__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_feedback_carousel__WEBPACK_IMPORTED_MODULE_5__);
...
if (coachesSection && coachesSwiper) {
  var coachesSlider = new Swiper('.coaches__swiper', {
    loop: true,
    autoHeight: true,
    breakpoints: {
      1200: {
...
/***/ "./js/modules/feedback-carousel.js":
/*!*****************************************!*\
  !*** ./js/modules/feedback-carousel.js ***!
  \*****************************************/
/*! no static exports found */
...
if (feedbackSection && feedbackSwiper) {
  var feedbackCarousel = new Swiper('.feedback__swiper', {
    loop: true,
    slidesPerView: 1,
    spaceBetween: 0,
    effect: 'coverflow',
...
var player = document.querySelector('.gym__video');
var button = document.querySelector('.gym__video-play');
var overlay = document.querySelector('.gym__video-overlay');
...
var tabWrappers = document.querySelectorAll('.subscriptions__tabs-item');
var tabs = document.querySelectorAll('.subscriptions__tab');
var tabsContentCollection = document.querySelectorAll('.subscriptions__group');
if (tabWrappers && tabs && tabsContentCollection) {
  var _loop = function _loop(i) {
    tabs[i].addEventListener('click', function (evt) {
      evt.preventDefault();
      tabsContentCollection.forEach(function (el) {
        el.classList.add('subscriptions__group--hidden');
      });
      tabWrappers.forEach(function (el) {
